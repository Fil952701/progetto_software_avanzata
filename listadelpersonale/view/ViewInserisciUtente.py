...
class ViewInserisciUtente(QWidget):
    def __init__(self, controller, update_ui, lista_dinamica):
        super(ViewInserisciUtente, self).__init__()
    ...
    def inserisci_utente(self):
        ...
        #Controllo inserimento di tutti i campi, non si possono inserire solo alcune delle informazioni
        ...
        # imposto dei valori di username e password se l'utente è amministratore
        ...
        if allert==True:
            QMessageBox.critical(self, 'Errore', 'Codice utente già presente in lista.', QMessageBox.Ok, QMessageBox.Ok)
            return
        else:
