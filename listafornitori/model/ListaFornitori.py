...
# definizione dei metodi per la lista fornitori
...
class ListaFornitori:
    ...
    def elimina_fornitore(self, fornitore_da_eliminare):
        for fornitore in self.lista_fornitori:
            if fornitore_da_eliminare == fornitore:
                self.lista_fornitori.remove(fornitore)
    ...
    # Come fatto precedentemente, ricarica in lista i dati da file pickle, se esistente e non vuoto, o dal file json
