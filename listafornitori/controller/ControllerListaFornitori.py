...
class ControllerListaFornitori():
    ...
    def elimina_fornitore(self, fornitore):
        self.model.elimina_fornitore(fornitore)

    # Lo stato di affiliazione passa automaticamente a Premium dopo 1 anno di stato Standard
