...
from utente.view.ViewModificaUtente import ViewModificaUtente

# implementazione della classe utente

class ViewUtente(QWidget):
    def __init__(self, utente, update_ui, controller, lista_dinamica, parent=None):
        super(ViewUtente, self).__init__(parent)
    ...
    # Parte Statica
        ...
        # istanzio due Label, una per il nome_cognome (Identificatore principale) e una per tutti gli altri campi
        ...
        # dimensione caratteri nome più grande per renderlo elemento principale
        ...
        # dimensione caratteri per gli altri campi uguale tra loro
        ...
        # aggiungo il nome al widget come campo primario
        ...
        # command buttons elimina e modifica passati poi al widget
    ...
    def show_modifica_utente(self):
        self.view_modifica_utente = ViewModificaUtente(self.utente_selezionato, self.controller_utente, self.controller_lista_del_personale, self.update_ui_utente)
        self.view_modifica_utente.show()
        self.update_ui()
