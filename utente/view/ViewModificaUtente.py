...
class ViewModificaUtente(QWidget):
    def __init__(self, utente, controller, controller_lista, update_ui_utente):
        super(ViewModificaUtente, self).__init__()
        ...
        # per evitare problematiche di duplicati nell'andare ad aggiungere un utente con lo stesso codice di uno già presente, si crea una lista temporanea dove posso ospitarlo
    ...
    # Parte Statica
        ...
        icon.addPixmap(QtGui.QPixmap(
            "C:\\Users\\Filippo\\Documents\\QtDesigner\\test\\../../../Pictures/Screenshots/Screenshot (206).png"), # DA MODIFICARE
    ...
    # Creazione e aggiunta di componenti dinamiche per le credenziali utente
    def retranslateUi_2(self):
        # indica se sto chiamando per la prima volta il metodo retranslate
        self.contatore= self.contatore+1 # inizialmente a 0
        ...
        if self.comboBox_ruolo.currentText()=="Amministratore":
            ...
            # aggiunta di entrambi i metodi al widget
    ...
    def save_data(self):
        ...
        # testo che utente inserisce trasferito in ciascuna LineEdit
        ...
        # Differenziazione tra utente semplice ed amministratore
    ...
    # stesso metodo delle altre view per gestire il box question
