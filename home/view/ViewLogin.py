...
class ViewLogin(QWidget):
    ...
    # PARTE STATICA
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap('listaprodotti/data/images/logo_start.jpg'), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.setWindowIcon(icon)
        self.setObjectName("Form")
        self.resize(400, 200)
        # uso QtWidgets per creare l'interfaccia dei pulsanti
        ...
        self.pushButton_annulla.clicked.connect(self.close) # quando il login viene effettuato
    ...
    # Verifica effettivamente se l'username e la password inserite sono valide
    def login(self):
    ...
    # Gestione dell'errore in caso di inserimento di credenziali errate.
    ...
    # Esecuzione di un determinato evento alla chiusura dell'interfaccia
