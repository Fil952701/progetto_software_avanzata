...
#from PyQt5.QtWidgets import QPalette, QBrush
import time
...
class ViewHome(QWidget):
    ...
    # Parte Statica
        ...
        '''palette = QPalette()
        palette.setBrush(QPalette.Background, QBrush(QPixmap("immagini_home/data/musica.jpg").scaled(self.size(), Qt.KeepAspectRatio)))
        ...
        self.pushButton_vendita.setMinimumHeight(int(self.height/5))
        self.pushButton_vendita.setMaximumHeight(int(self.height/5))
        ...
        self.pushButton_vendita.setStyleSheet("QPushButton {\n"
                                              "    border-radius:22px;\n"
                                              "    background-color:rgb(218, 26, 108);\n"
                                              "    color:white;\n"
                                              "    border-style: outset;\n" 
                                              "    border-width: 4px;\n"    
                                              "    border-color: black;\n"  
        ...
        self.pushButton_vendita.setIconSize(QSize(int(self.width / 7), int(self.height / 7)))
        ...
        self.pushButton_prodotti.setMaximumHeight(int(self.height/5))
        self.pushButton_prodotti.setMaximumWidth(int(self.width / 6))
        ...
        self.pushButton_prodotti.setIconSize(QSize(int(self.width / 6), int(self.height / 6)))
        ...
        self.pushButton_ordini.setMaximumHeight(int(self.height/5))
        self.pushButton_ordini.setMaximumWidth(int(self.width / 6))
        ...
        self.pushButton_ordini.setIconSize(QSize(int(self.width / 9), int(self.height / 9)))
    ...
    def retranslateUi(self):
        ...
        self.label_4.setText(_translate("Home", "Catalogo"))
        ...
        if self.controller_lista_del_personale.get_status():
            ...
            self.push_button_login.setMinimumSize(QtCore.QSize(150, int(self.height / 22)))
            self.push_button_login.setObjectName("push_button_login")
            self.push_button_login.setMaximumSize(int(self.width / 13), int(self.height / 22))
            ...
            self.pushButton_personale.setMinimumSize(QtCore.QSize(130, int(self.height/5)))
            self.pushButton_personale.setMaximumHeight(int(self.height/5))
            self.pushButton_personale.setMaximumWidth(int(self.width / 6))
            ...
            self.pushButton_personale.setIconSize(QSize(int(self.width / 6), int(self.height / 6)))
            ...
            self.pushButton_fornitori.setMinimumSize(QtCore.QSize(130, int(self.height / 5)))
            self.pushButton_fornitori.setMaximumHeight(int(self.height/ 5))
            ...
            self.pushButton_fornitori.setIconSize(QSize(int(self.width / 7), int(self.height / 7)))
            ...
            pixmap = QPixmap('immagini_home/data/musica.jpg')
            ...
            self.label_6.setWindowIcon(icon)
            self.gridLayout_2.addWidget(self.label_6, 7, 3, 1, 1)
