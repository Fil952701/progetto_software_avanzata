...
class ViewModificaOrdine(QWidget):
    def __init__(self, ordine, controller, update_ui, lista_prodotti_ordine, lista_dinamica_ordini, parent=None):
        ...
        # si utilizza sempre lista temporanea per evitare problematiche di duplicazione e sovrascrittura
    ...
    def save_data_click(self):
        ...
        # imposto i campi dell'ordine a tutti i prodotti in lista_prodotti_ordine
