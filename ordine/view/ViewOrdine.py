...
from ordine.view.ViewModificaOrdine import ViewModificaOrdine
from prodotto.view.ViewProdotto import ViewProdotto


class ViewOrdine(QWidget):
    def __init__(self, ordine, update_ui, controller_lista_ordini, controller_lista_prodotti, lista_dinamica_ordini, parent=None):
        super(ViewOrdine, self).__init__(parent)
    ...
    def retranslateUi(self):
        ...
        item.setText(_translate("self", "Categoria"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("self", "Quantità"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("self", "Tipologia"))
        ...
        # Inizialmente sono inizializzati a 0
        ...
        self.label_9.setText(_translate("Form", "Strumenti totali: {}".format(str(strumenti_totali))))
    ...
    def show_prodotto(self):
        if len(self.tableWidget.selectedIndexes()) > 0:
            ...
            self.view_prodotto = ViewProdotto(prodotto_selezionato, self.retranslateUi, self.controller_lista_prodotti, None)
            self.view_prodotto.showMaximized()
            time.sleep(0.3)
    ...
    def show_modifica_ordine(self):
        self.view_modifica_ordine= ViewModificaOrdine(self.ordine_selezionato, self.controller_ordine, self.retranslateUi, self.lista_prodotti_ordine, self.lista_dinamica_ordini)
        self.view_modifica_ordine.show()
