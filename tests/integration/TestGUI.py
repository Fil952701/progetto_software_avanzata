...
def runProgram():
    subprocess.run(["python3.9", 'main.py'])
...
def test_login():
    ...
    login_button_coords = pyautogui.locateCenterOnScreen('immagini_test/login_button.jpg', confidence=0.4)
    ...
    user_form_coords = pyautogui.locateCenterOnScreen('immagini_test/user_form.jpg', confidence=0.4)
    ...
    pass_form_coords = pyautogui.locateCenterOnScreen('immagini_test/pass_form.jpg', confidence=0.4)
    ...
    loginto_button_coords = pyautogui.locateCenterOnScreen('immagini_test/loginto_button.jpg', confidence=0.4)
...
def test_ordini():
    ordini_button_coords = pyautogui.locateCenterOnScreen('immagini_test/ordini.jpg', confidence=0.3)
    pyautogui.moveTo(ordini_button_coords.x, ordini_button_coords.y, 0.3)
    pyautogui.click(ordini_button_coords)
    time.sleep(0.5)
    nuovo_button_coords = pyautogui.locateCenterOnScreen('immagini_test/nuovo.jpg', confidence=0.3)
    pyautogui.moveTo(nuovo_button_coords.x, nuovo_button_coords.y, 0.3)
    pyautogui.click(nuovo_button_coords)
    time.sleep(0.5)
    codice_fattura_form= pyautogui.locateCenterOnScreen('immagini_test/codice_fattura_form.jpg', confidence=0.3)
    ...
    time.sleep(0.3)
    codice_fornitore_form= pyautogui.locateCenterOnScreen('immagini_test/codice_fornitore_form.jpg', confidence=0.3)
    ...
    inserisci_prodotto_ordini= pyautogui.locateCenterOnScreen('immagini_test/inserisci_prodotto_ordini.jpg', confidence=0.3)
    pyautogui.moveTo(inserisci_prodotto_ordini.x, inserisci_prodotto_ordini.y, 0.3)
    pyautogui.click(inserisci_prodotto_ordini)
    time.sleep(0.3)
    codice_prodotto_form= pyautogui.locateCenterOnScreen('immagini_test/codice_prodotto_form.jpg', confidence=0.3)
    ...
    quantita_form= pyautogui.locateCenterOnScreen('immagini_test/quantita.jpg', confidence=0.3)
    pyautogui.moveTo(quantita_form.x, quantita_form.y, 0.3)
    pyautogui.click(quantita_form)
    pyautogui.write("10", 0.1)
    pyautogui.scroll(-5)
    prezzo_acquisto_form= pyautogui.locateCenterOnScreen('immagini_test/prezzo_acquisto_form.jpg', confidence=0.3)
    ...
    salva_prodotti= pyautogui.locateCenterOnScreen('immagini_test/salva_prodotti_ordine.jpg', confidence=0.3)
    time.sleep(0.3)
    pyautogui.moveTo(salva_prodotti.x, salva_prodotti.y, 0.3)
    pyautogui.click(salva_prodotti)
    salva= pyautogui.locateCenterOnScreen('immagini_test/salva.jpg', confidence=0.3)
    pyautogui.moveTo(salva.x, salva.y, 0.3)
    pyautogui.click(salva)
    time.sleep(0.3)
    in_arrivo= pyautogui.locateCenterOnScreen('immagini_test/In_arrivo.jpg', confidence=0.3)
    pyautogui.moveTo(in_arrivo.x, in_arrivo.y, 0.3)
    pyautogui.click(in_arrivo)
    ordine_test= pyautogui.locateCenterOnScreen('immagini_test/ordine_test.jpg', confidence=0.3)
    pyautogui.moveTo(ordine_test.x, ordine_test.y, 0.3)
    pyautogui.click(ordine_test)
    apri= pyautogui.locateCenterOnScreen('immagini_test/apri.jpg', confidence=0.3)
    pyautogui.moveTo(ordine_test.x, ordine_test.y, 0.3)
    pyautogui.click(apri)
    time.sleep(0.3)
    elimina= pyautogui.locateCenterOnScreen('immagini_test/elimina_ordine.jpg', confidence=0.3)
    pyautogui.moveTo(elimina.x, elimina.y, 0.3)
    pyautogui.click(elimina)
    time.sleep(0.3)
    yes= pyautogui.locateCenterOnScreen('immagini_test/yes.jpg', confidence=0.3)
    pyautogui.moveTo(yes.x, yes.y, 0.3)
    pyautogui.click(yes)
    time.sleep(0.3)
    home= pyautogui.locateCenterOnScreen('immagini_test/home.jpg', confidence=0.3)
...
def test_listaprodotti():
    prodotti = pyautogui.locateCenterOnScreen('immagini_test/prodotti.jpg', confidence=0.4)
    pyautogui.click(prodotti)
    time.sleep(3)
    in_negozio = pyautogui.locateCenterOnScreen('immagini_test/in_negozio_prodotti.jpg', confidence=0.4)
    pyautogui.click(in_negozio)
    time.sleep(6)
    in_arrivo = pyautogui.locateCenterOnScreen('immagini_test/in_arrivo_prodotti.jpg', confidence=0.4)
    time.sleep(6)
    pyautogui.click(in_arrivo)
    time.sleep(6)
    home= pyautogui.locateCenterOnScreen('immagini_test/home.jpg', confidence=0.4)
    pyautogui.moveTo(home.x, home.y, 0.3)
    pyautogui.click(home)
...
def test_listadelpersonale():
    personale= pyautogui.locateCenterOnScreen('immagini_test/personale.jpg', confidence=0.4)
    pyautogui.moveTo(personale.x, personale.y, 0.3)
    pyautogui.click(personale)
    time.sleep(0.5)
    utente_test= pyautogui.locateCenterOnScreen('immagini_test/utente_test.jpg', confidence=0.4)
    pyautogui.moveTo(utente_test.x, utente_test.y, 0.3)
    pyautogui.click(utente_test)
    apri= pyautogui.locateCenterOnScreen('immagini_test/apri.jpg', confidence=0.4)
    pyautogui.moveTo(apri.x, apri.y, 0.3)
    pyautogui.click(apri)
    time.sleep(0.5)
    modifica_utente= pyautogui.locateCenterOnScreen('immagini_test/modifica_utente.jpg', confidence=0.4)
    pyautogui.moveTo(modifica_utente.x, modifica_utente.y, 0.3)
    pyautogui.click(modifica_utente)
    time.sleep(0.5)
    annulla_utente= pyautogui.locateCenterOnScreen('immagini_test/annulla_utente.jpg', confidence=0.4)
    pyautogui.moveTo(annulla_utente.x, annulla_utente.y, 0.3)
    pyautogui.click(annulla_utente)
    time.sleep(0.5)
    yes= pyautogui.locateCenterOnScreen('immagini_test/yes.jpg', confidence=0.4)
    pyautogui.moveTo(yes.x, yes.y, 0.3)
    pyautogui.click(yes)
    time.sleep(0.5)
...
def test_logout():
    logout= pyautogui.locateCenterOnScreen('immagini_test/logout.jpg', confidence=0.4)
    pyautogui.moveTo(logout.x, logout.y, 0.3)
    pyautogui.click(logout)
    time.sleep(0.6)
    yes= pyautogui.locateCenterOnScreen('immagini_test/yes2.jpg', confidence=0.4)
    pyautogui.moveTo(yes.x, yes.y, 0.3)
    pyautogui.click(yes)
    time.sleep(0.5)
    pyautogui.hotkey('alt','f4')
    time.sleep(0.6)
    yes= pyautogui.locateCenterOnScreen('immagini_test/yes3.jpg', confidence=0.4)
    pyautogui.click(yes)
