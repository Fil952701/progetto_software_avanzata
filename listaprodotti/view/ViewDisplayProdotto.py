...
from prodotto.view.ViewProdotto import ViewProdotto
       ...
       #DISPLAY DEL SINGOLO PRODOTTO IN ViewListaProdotti
       # Contiene le informazioni necessarie per costruire l'interfaccia di ogni singolo record della lista


#definizione della classe

class ViewDisplayProdotto(QWidget):
    def __init__(self, prodotto, update_ui, controller, lista_prodotti):
        super(ViewDisplayProdotto, self).__init__()
    ...
    # Parte Statica
       ...
       # Definizione dei vari form presenti all'interno della vista
    ...
    def show_prodotto(self):
        self.view_prodotto = ViewProdotto(self.prodotto, self.update_ui, self.controller, self.lista_prodotti_filtrata)
