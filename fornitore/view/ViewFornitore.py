...
from fornitore.view.ViewModificaFornitore import ViewModificaFornitore

class ViewFornitore(QWidget):
    def __init__(self, fornitore, update_ui, controller, lista_dinamica, parent=None):
        super(ViewFornitore, self).__init__(parent)
        ...
        # boolean che permette di eseguire due eventi diversi in caso di chiusura della finestra. Da usare successivamente nella distinzione dei casi si e no
        self.end1 = False
    ...
    # Parte Statica
        ...
        #istanzio due Label, una per il nome (in testa) e una per il body
        self.label_nome= QLabel() # testa
        ...
        # chiamo le parti dinamiche: update_ui per aggiornare la lista fornitori e update_ui_fornitore per aggiornare i campi
        self.update_ui()
        ...
        # imposto un carattere minore per il body
        ...
        #aggiungo il nome al widget (contenitore)
        ...
        #creo i bottoni elimina e modifica come nelle altre viste
    ...
    def show_modifica_fornitore(self):
        self.view_modifica_fornitore= ViewModificaFornitore(self.fornitore_selezionato, self.controller_fornitore, self.controller_lista_fornitori, self.update_ui_fornitore)
        self.view_modifica_fornitore.show()
        self.update_ui()
